                                    ...
                                    <div className="absolute inset-0 bg-black/50 flex flex-col justify-end p-4">
                                        ...
                                        <div className="flex gap-3 justify-center items-center">
                                            ...
                                            <button
                                                ...
                                                className="relative w-[120px] h-10 px-3 bg-purple-600 text-white border-none rounded-md text-sm font-bold cursor-pointer z-10 group overflow-hidden flex items-center justify-center">
                                                🎟 Đặt vé nha
